...
import 'package:pawarwoodcarving/screens/web%20screens/web%20widgets/view_more_button_web.dart';
import '../../../utils/colors.dart';
import '../../common widgets/texts/poppins_medium.dart';
import '../../common widgets/texts/poppins_regular.dart';
import 'half_to_full_underline_text.dart';

class ProductCardWidgetWeb extends StatefulWidget {
  const ProductCardWidgetWeb({super.key, required this.img, required this.index, required this.currentpageval});
  ...
  @override
  State<ProductCardWidgetWeb> createState() => _ProductCardWidgetWebState();
}

class _ProductCardWidgetWebState extends State<ProductCardWidgetWeb> {
